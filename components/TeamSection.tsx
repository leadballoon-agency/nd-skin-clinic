  ...
  const team = [
    {
      ...
      bio: 'GMC registered doctor with background in General Medicine, practiced in NHS hospitals before moving into Aesthetic Medicine. 15 years of Aesthetic Medicine experience with a holistic approach to deliver natural anti-aging results using medical skincare and injectables.',
      qualifications: [
        'Medical Doctor (MBs Ch, MD)',
        'GMC Registered',
        '15 Years Aesthetic Medicine',
        'ZO Skin Health & Injectables Specialist'
      ]
    }
  ]
        ...
        <div className="mt-12 sm:mt-16 bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg sm:shadow-premium">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-xs sm:text-sm text-neutral-600">Doctor-led treatments</p>
            </div>
            <div>
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
